...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        // Add Automatic Deduction menu item
        JMenu deductionMenu = new JMenu("Deductions");
        JMenuItem automaticDeductionItem = new JMenuItem("Automatic Absence Deduction");
        
        automaticDeductionItem.addActionListener(e -> {
            new AutomaticDeduction().setVisible(true);
        });
        
        deductionMenu.add(automaticDeductionItem);
        jMenuBar1.add(deductionMenu);

        // Add Facial Recognition menu items
        JMenu attendanceMenu = new JMenu("Attendance");
        JMenuItem faceRecognitionItem = new JMenuItem("Face Recognition Attendance");
        JMenuItem faceEnrollmentItem = new JMenuItem("Enroll Employee Face");
        
        faceRecognitionItem.addActionListener(e -> {
            new FaceRecognitionAttendance().setVisible(true);
        });
        
        faceEnrollmentItem.addActionListener(e -> {
            new FaceEnrollment().setVisible(true);
        });
        
        attendanceMenu.add(faceRecognitionItem);
        attendanceMenu.add(faceEnrollmentItem);
